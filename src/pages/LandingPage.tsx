        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-8">
            ...
            <p className="text-sm leading-relaxed text-[var(--text-2)]">
              Utiliza <strong className="font-semibold text-[var(--text)]">GPT-5-mini de OpenAI</strong>, un modelo de inteligencia artificial avanzado que entiende contexto, explica conceptos complejos de forma simple y aprende de tus preguntas para personalizar las respuestas.
            </p>
          </div>
...
function FAQ() {
  const faqs = [
    ...
    { q: "¿De dónde saca la información MIMIR?", a: "MIMIR utiliza GPT-5-mini de OpenAI, un modelo de inteligencia artificial avanzado entrenado con grandes corpus de conocimiento. En cada respuesta, te indica las fuentes (Wikipedia, sitios .edu, .gov, MDN, Khan Academy, entre otros) para que puedas verificar la información." },
